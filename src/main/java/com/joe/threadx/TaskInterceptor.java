...
public interface TaskInterceptor {
    ...
    /**
     * 加入线程池前调用
     * @param task 将要执行的任务，不能为空，可能是{@link Runnable}，也可能是{@link java.util.concurrent.Callable}
     ...
     *
     * @param task 任务，不能为空
     * @param e 异常，不能为空，可能是{@link Runnable}，也可能是{@link java.util.concurrent.Callable}
     ...
     * @throws ThreadxException 校验失败时抛出异常
     */
